...
public class MaximumVacationDays {
	...
	private int[][] init(int cities, int weeks) {
	...
	private int dfs(int[][] flights, int[][] days, int[][] dp, int city, int week) {
	...
	public static void main(String[] args) {
		...
		System.out.println(solution.maxVacationDays(flights, days));
		// output: 12
	}
